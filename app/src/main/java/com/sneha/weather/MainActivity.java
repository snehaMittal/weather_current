...
import com.sneha.weather.Common.Common;
import com.sneha.weather.Helper.Helper;
import com.sneha.weather.Model.OpenWeatherMap;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtHumidty = (TextView) findViewById(R.id.txtHumidity);
    ...
    private class GetWeather extends AsyncTask<String , Void , String>{
        ...
        protected void onPostExecute(String s) {
            ...
            txtHumidty.setText(String.format("%d%%" , openWeatherMap.getMain().getHumidity()));
